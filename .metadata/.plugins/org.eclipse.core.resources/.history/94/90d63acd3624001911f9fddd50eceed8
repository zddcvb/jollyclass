package
{
	...
	public class JollyClassPlayer extends Sprite
	{
		...
		private var arr:Array=new Array("my-customuri://result=/swf/an.swf&product_type=familybox&resource_type=xsd&customer_service_tel=13632220258&family_media_id=1234&family_material_id=123456");
		...
		{
				dataInfo=ParseDataUtils.parseDataInfo(arr);
				if(dataInfo!=null){
